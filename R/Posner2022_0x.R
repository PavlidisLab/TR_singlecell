...
sc_dir <- "/cosmos/data/downloaded-data/sc_datasets_w_supplementary_files/lab_projects_datasets/amorin_sc_datases/Mouse/Posner2022/"
dat_path <- file.path(sc_dir, "Posner2022.RDS")
out_path <- "/space/scratch/amorin/R_objects/Posner2022_mat_and_meta.RDS"
