...
coexpr_recover_curated_hg_path <- "/space/scratch/amorin/R_objects/coexpr_recover_curated_hg_lognorm.RDS"
coexpr_recover_curated_mm_path <- "/space/scratch/amorin/R_objects/coexpr_recover_curated_mm_lognorm.RDS"
