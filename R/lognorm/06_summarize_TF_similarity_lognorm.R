...
sim_tf_hg <- readRDS(paste0("/space/scratch/amorin/R_objects/similarity_TF_hg_k=", k, "_lognorm.RDS"))
# sim_tf_mm <- readRDS(sim_tf_mm_path)
sim_tf_mm <- readRDS(paste0("/space/scratch/amorin/R_objects/similarity_TF_mm_k=", k, "_lognorm.RDS"))

# L/S ribo topk overlap
# sim_ribo_hg <- readRDS(sim_ribo_hg_path)
sim_ribo_hg <- readRDS(paste0("/space/scratch/amorin/R_objects/similarity_ribo_hg_k=", k, "_lognorm.RDS"))
# sim_ribo_mm <- readRDS(sim_ribo_mm_path)
sim_ribo_mm <- readRDS(paste0("/space/scratch/amorin/R_objects/similarity_ribo_mm_k=", k, "_lognorm.RDS"))

# Null topk overlap
# sim_null_hg <- readRDS(sim_null_hg_path)
sim_null_hg <- readRDS(paste0("/space/scratch/amorin/R_objects/similarity_null_hg_k=", k, "_lognorm.RDS"))
# sim_null_mm <- readRDS(sim_null_mm_path)
sim_null_mm <- readRDS(paste0("/space/scratch/amorin/R_objects/similarity_null_mm_k=", k, "_lognorm.RDS"))
