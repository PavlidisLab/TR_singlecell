...
erminer_coexpr_hg_path <- "/space/scratch/amorin/R_objects/coexpr_erminer_hg.RDS"
erminer_coexpr_mm_path <- "/space/scratch/amorin/R_objects/coexpr_erminer_mm.RDS"
erminer_coexpr_ortho_path <- "/space/scratch/amorin/R_objects/coexpr_erminer_ortho.RDS"
