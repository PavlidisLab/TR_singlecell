## Process count matrix and get aggregate correlation for Tabula Sapiens, without
...
processed_path <- file.path(out_dir, paste0(id, "_clean_mat_and_meta_nofilter.RDS"))
allrank_path <- file.path(out_dir, paste0(id, "_RSR_allrank_nofilter.RDS"))
colrank_path <- file.path(out_dir, paste0(id, "_RSR_colrank_nofilter.RDS"))
zcor_path <- file.path(out_dir, paste0(id, "_fishersZ_nofilter.RDS"))
