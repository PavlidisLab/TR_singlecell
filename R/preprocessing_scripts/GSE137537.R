## Process count matrix and get aggregate correlation for GSE137537.
## NOTE: This was separated as the "counts" slot from the Seurat object was
## empty, but the "data" slot does not look normalized (integer counts)
## -----------------------------------------------------------------------------
...
if (!file.exists(processed_path)) {
  ...
  mat <- GetAssayData(dat, slot = "data")  # GSE137537 specific
