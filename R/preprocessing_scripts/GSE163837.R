...
# Files were directly downloaded from GEO, see GSE163837_download.sh in dat_dir
...
# Remove CITE-seq/ADT files
mat_path <- mat_path[!str_detect(mat_path, "ADT")]
barcodes_path <- barcodes_path[!str_detect(barcodes_path, "ADT")]
