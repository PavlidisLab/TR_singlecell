...
# Files were directly downloaded from GEO, see GSE202734_download.sh in dat_dir
...
if (!file.exists(processed_path)) {
  ...
  meta <- data.frame(ID = str_replace(meta$cell.ID, "\\..*$", ""), meta)
  ...
  # Ready metadata
  # "GSE202734" remove NA cell types
