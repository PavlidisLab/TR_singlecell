...
# Files were directly downloaded from GEO, see GSE206202_download.sh in dat_dir
...
if (!file.exists(processed_path)) {
  ...
  # Ready metadata
  # "GSE206202" collapse cell types with integer delim
  
  change_colnames <- c(Cell_type = "cluster")
