...
# Files were directly downloaded from GEO, see GSE142645Human_download.sh in dat_dir
...
if (!file.exists(processed_path)) {
  ...
  # "GSE142645Human" had to directly access counts
  ...
  change_colnames <- c(Cell_type = "new_anno")
