...
# Files were directly downloaded from GEO, see GSE213604_download.sh in dat_dir
...
if (!file.exists(processed_path)) {
  ...
  # Ready metadata
  # "GSE213604" collapse cell types with integer delim and remove ambiguous
  ...
  meta <- filter(meta, !str_to_lower(Cell_type) == "unknown")
  mat <- mat[, meta$ID]
