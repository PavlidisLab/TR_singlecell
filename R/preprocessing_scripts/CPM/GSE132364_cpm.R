...
# Files were directly downloaded from GEO, see GSE132364_download.sh in dat_dir
dat_path <- file.path(dat_dir, paste0(id, "_seurat.Rdata"))
...
if (!file.exists(processed_path)) {
  ...
  # Extract count matrix: GSE132364 can't retrieve counts so get data
  ...
  # "GSE132364" already seurat log normalized, reverse log
