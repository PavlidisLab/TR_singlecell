...
# Files were directly downloaded from GEO, see GSE182506_download.sh in dat_dir
...
if (!file.exists(processed_path)) {
  ...
  # Ready metadata
  # "GSE182506" collapse broad cell types (remove integer delim)
  
  change_colnames <- c(Cell_type = "shortName")
