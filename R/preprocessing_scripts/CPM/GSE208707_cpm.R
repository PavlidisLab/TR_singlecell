...
# Files were directly downloaded from GEO, see GSE208707_download.sh in dat_dir
...
if (!file.exists(processed_path)) {
  ...
  # Ready metadata
  # "GSE208707" collapse cell types with integer delim
  
  change_colnames <- c(Cell_type = "cluster.ids", ID = "X")
