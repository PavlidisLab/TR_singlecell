...
# Generate full symmetric correlation matrix. 
# NA cors are set to 0
# Ranking is done column/gene-wise before aggregating.
...
# Generate full symmetric correlation matrix. 
# NA cors are set to 0
# Set cor to triangular (prevent double ranking symmetric matrix)
# Diag is set to 1 (prevent NA self-cor)
# Ranking considers the entire tri matrix, keeping diag as 1=best, before aggregating
...
# Generate full symmetric correlation matrix. 
# Rank the correlation matrix column-gene wise, preserving NAs
# NA ranks are set to the average rank of the whole matrix before aggregating.
